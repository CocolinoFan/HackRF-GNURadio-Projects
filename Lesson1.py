...
class Lesson1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.chanel_freq = chanel_freq = 102.7e6
        self.center_freq = center_freq = 97.9e6
        self.audio_gain = audio_gain = 0.01

        ##################################################
        # Blocks
        ##################################################

        self._audio_gain_range = qtgui.Range(0, 2, 0.01, 0.01, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.chanel_freq, self.samp_rate)
    ...
    def set_chanel_width(self, chanel_width):
        ...
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(self.chanel_freq, self.chanel_width)
        self.qtgui_freq_sink_x_0_0_0_0.set_frequency_range(self.chanel_freq, self.chanel_width)
